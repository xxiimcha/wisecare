...
RETURNS table(
  ...
  mode_of_premium text, due_date date, or_number text, or_date date, sa_number text, amount numeric, 
  total_contract_value numeric, balance numeric, billing_period int, summary_of_benefits text, 
  name_of_signatory text, designation_of_contact_person text, email_address_of_contact_person text, 
  ...
  begin
    return query
      SELECT 
        ...
        mp2.name::text as mode_of_premium, a.due_date, a.or_number::text, a.or_date, a.sa_number::text, a.amount::numeric, 
        a.total_contract_value::numeric, a.balance::numeric, a.billing_period, a.summary_of_benefits::text, 
        a.name_of_signatory::text, a.designation_of_contact_person::text, a.email_address_of_contact_person::text, 
