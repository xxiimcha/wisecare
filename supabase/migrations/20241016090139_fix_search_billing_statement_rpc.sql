...
RETURNS table(
  id uuid, account_id uuid, account_name text, mode_of_payment text, due_date date, or_number text, or_date date, sa_number text, amount float, 
...
AS $$
  begin
    return query
      SELECT 
        b.id, b.account_id, a.company_name::text as account_name, mp.name::text as mode_of_payment, b.due_date, b.or_number, b.or_date, b.sa_number, b.amount, 
