...
import { formatPercentage } from '@/app/(dashboard)/(home)/accounts-corporate-sme/columns/accounts-columns'
...
const AccountInformationFields = dynamic(
  () =>
    import(
      '@/app/(dashboard)/(home)/accounts-corporate-sme/(Personnel)/[id]/(company profile)/edit/account-information-fields'
    ),
  { ssr: false },
)
